...
class PackageManifestTests(unittest.TestCase):
    ...
    def test_manifest_includes_public_docs_needed_by_tests(self) -> None:
        ...
        self.assertIn("include docs/agent_orchestration_roles_ko.md", text)
        self.assertIn("include docs/authoring_beginner_improvement_backlog_ko.md", text)
        self.assertIn("include docs/authoring_beginner_pilot_facilitator_script_ko.md", text)
        self.assertIn("include docs/authoring_go_nogo_memo_template_ko.md", text)
        self.assertIn("include docs/image_pipeline_6hour_execution_plan_ko.md", text)
        self.assertIn("include docs/image_pipeline_implementation_ko.md", text)
        self.assertIn("include docs/local_ai_runtime_runbook_ko.md", text)
        self.assertIn("include docs/local_llm_image_based_detailed_roadmap_ko.md", text)
        self.assertIn("include docs/local_llm_platform_implementation_plan_ko.md", text)
        self.assertIn("include docs/local_llm_regulation_platform_direction_ko.md", text)
